...
ComboBox {
    ...
    property alias _indicator_icon_visible: canvas.visible
    property alias _enabled: control.enabled
    /*显示的文字*/
    opacity: pressed ? 0.5 :1.0

    contentItem: Text {
        leftPadding: 4
        text: (control.model.get(currentIndex).value*100).toFixed(0)+"%"  //control.displayText
        font: control.font
...
//            border.width: 1
           // radius: 4
            ...
            Text {
                ...
                text: (model.value* 100).toFixed(0)+"%"
